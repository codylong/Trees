...
this and related points.}. Here ``less than'' means at least one of the orders is less than the given order. % We refer to this latter criterion as the weak OOV (orders
%of vanishing) criterion. 
 We now translate this order of vanishing (OOV) condition to constraint on the height of the tree.% is sufficient but not necessary for at worst canonical singularities; for example a rich set of $6d$ $N=1$
