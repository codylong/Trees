...
\hspace{1cm}%
\begin{tikzpicture}
\draw[thick,color=ForestGreen] (0,0) -- (0,3.6) -- (3,0) -- cycle;
%\draw[thick,color=ForestGreen] (0,0) -- (0,.3);
%\draw[thick,color=ForestGreen] (0,.3) -- (0,.6);
%\draw[thick,color=ForestGreen] (0,.6) -- (0,.9);
%\draw[thick,color=ForestGreen] (0,.9) -- (0,1.2);
%\draw[thick,color=ForestGreen] (0,1.2) -- (0,1.5);
%\draw[thick,color=ForestGreen] (0,1.5) -- (0,1.8);
%\draw[thick,color=ForestGreen] (0,1.8) -- (0,2.1);
%\draw[thick,color=ForestGreen] (0,2.1) -- (0,2.4);
%\draw[thick,color=ForestGreen] (0,2.4) -- (0,2.7);
%\draw[thick,color=ForestGreen] (0,2.7) -- (0,3);
%\draw[thick,color=ForestGreen] (0,3) -- (0,3.3);
%\draw[thick,color=ForestGreen] (0,3.3) -- (0,3.6);
\draw[thick,color=ForestGreen] (1,0) -- (1,.3);
\draw[thick,color=ForestGreen] (1,.3) -- (1,.6);
\draw[thick,color=ForestGreen] (1,.6) -- (1,.9);
\draw[thick,color=ForestGreen] (1,.9) -- (1,1.2);
\draw[thick,color=ForestGreen] (1,1.2) -- (1,1.5);
\draw[thick,color=ForestGreen] (1,1.5) -- (1,1.8);
\draw[thick,color=ForestGreen] (1,1.8) -- (1,2.1);
\draw[thick,color=ForestGreen] (1,2.1) -- (1,2.4);
\draw[thick,color=ForestGreen] (2,0) -- (2,.3);
\draw[thick,color=ForestGreen] (2,.3) -- (2,.6);
\draw[thick,color=ForestGreen] (2,.6) -- (2,.9);
\draw[thick,color=ForestGreen] (2,.9) -- (2,1.2);
\draw[thick,color=ForestGreen] (0,2.7) -- (3,0);
\draw[thick,color=ForestGreen] (0,1.8) -- (3,0);
\draw[thick,color=ForestGreen] (0,.9) -- (3,0);
\draw[thick,color=ForestGreen] (2,1.2) -- (0,3.0);
\draw[thick,color=ForestGreen] (2,.9) -- (0,3.3);
\draw[thick,color=ForestGreen] (2,.6) -- (0,2.4);
\draw[thick,color=ForestGreen] (2,.3) -- (0,2.1);
\draw[thick,color=ForestGreen] (2,.3) -- (0,1.5);
\draw[thick,color=ForestGreen] (2,0) -- (0,.6);
\draw[thick,color=ForestGreen] (2,0) -- (0,1.2);
\draw[thick,color=ForestGreen] (2,.6) -- (0,3.0);
\draw[thick,color=ForestGreen] (1,2.1) -- (0,3.6);
\draw[thick,color=ForestGreen] (1,1.5) -- (0,2.1);
\draw[thick,color=ForestGreen] (1,1.5) -- (0,2.7);
\draw[thick,color=ForestGreen] (1,.9) -- (0,1.8);
\draw[thick,color=ForestGreen] (1,.6) -- (0,1.5);
\draw[thick,color=ForestGreen] (1,.3) -- (0,.9);
\draw[thick,color=ForestGreen] (1,0) -- (0,.6);
\draw[thick,color=ForestGreen] (1,0) -- (0,.3);
...
from which we see $\#\tilde E=63$ and $\#\tilde F=36$ in both faces.}
